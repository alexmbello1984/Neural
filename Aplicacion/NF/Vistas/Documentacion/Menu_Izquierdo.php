    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
			<li><a href="<?php echo NeuralRutasApp::RutaURL('Documentacion/BasesDatos'); ?>"><i class="icon-chevron-right"></i> Bases de Datos</a></li>
			...
			<li><a href="<?php echo NeuralRutasApp::RutaURL('Documentacion/Formularios'); ?>"><i class="icon-chevron-right"></i> Formularios</a></li>
			<li><a href="<?php echo NeuralRutasApp::RutaURL('Documentacion/Sesiones'); ?>"><i class="icon-chevron-right"></i> Sesiones</a></li>
        </ul>
      </div>
      <div class="span9">